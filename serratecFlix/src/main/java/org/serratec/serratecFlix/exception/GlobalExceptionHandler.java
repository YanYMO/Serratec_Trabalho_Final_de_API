...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingPathVariable(MissingPathVariableException ex,
        ...
        ErroResposta erro = new ErroResposta(HttpStatus.BAD_REQUEST.value(),
                "A variável utilizada no caminho está incorreta ou está faltando!");
    ...
    public ResponseEntity<ErroResposta> handleTypeMismatch(
        ...
        ErroResposta erro = new ErroResposta(HttpStatus.BAD_REQUEST.value(),
                "Valor de Entrada Inválido! Verifique e tente novamente");
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(erro);
    }

    @ExceptionHandler(ValorNaoEncontradoException.class)
    public ResponseEntity<ErroResposta> handleValorNaoEncontrado(ValorNaoEncontradoException ex) {
    ...
    public ResponseEntity<ErroResposta> handleEnumValidation(EnumValidationException ex) {
    ...
    public ResponseEntity<ErroResposta> handleIdade(IdadeInsuficienteException ex) {
        ErroResposta erro = new ErroResposta(HttpStatus.FORBIDDEN.value(), ex.getMessage());
